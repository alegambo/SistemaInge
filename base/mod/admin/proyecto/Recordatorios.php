...
$sAjaxSource = $mySessionController->getVar('cds_domain') . $mySessionController->getVar('cds_locate') . 'mod/admin/proyecto/ajax_listar_recordatorios.php';

?>

<div class="well well-sm"><h1>Recordatorios Agendados</h1></div>
<?php if($user_rol == 4 ){ ?>
...
<script type="text/javascript" charset="utf-8">
    ...
    <?php if($user_rol != 3){ ?>
         ...
         <a class="btn btn-success" name="submit" onclick="javascript:OpcionMenu('mod/admin/proyecto/agregar_recordatorio.php?', '');"><i class="fa fa-save fa-inverse"></i> <?= "Agendar". " " . "Recordatorio" ?></a>
        </div>
     <?php } ?> 
    </div>
