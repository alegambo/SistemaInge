...
$sTable = "vis_miem";
$aColumns = array('Cod_SIA','Proyecto','Cedula','Nombre Miembro','Telefono','Correo');
$sIndexColumn = "Cedula";
/*---------------------------------------------------------*/
...
$output['aaData'] = seleccion_tabla_miembros_proyecto($sQuery, $sIndexColumn, $aColumns, $aActions);
