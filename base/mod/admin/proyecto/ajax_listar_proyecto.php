...
$sTable = "sis_proy_inv";
$aColumns = array('Cod_SIA','Nom_Proy','Cod_Ban','Ent_Ad','Num_Cue','Fech_Ini','Fech_Fin','Estado');
$sIndexColumn = "Cod_SIA";
...
$aActions = array(
    "sView" => 'verProyecto',
    "sEdit" => 'editarProyecto',
    "sPrin" => '',
    "sDele" => 'eliminarProyecto',
    "sAdd" => 'generarReporteProyecto');
